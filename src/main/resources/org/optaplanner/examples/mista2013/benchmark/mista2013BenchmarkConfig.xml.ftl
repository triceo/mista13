...
<plannerBenchmark>
  ...
  <inheritedSolverBenchmark>
    <problemBenchmarks>
      <problemIOClass>org.optaplanner.examples.mista2013.persistence.Mista2013ProblemIO</problemIOClass>
    ...
    <solver>
      <solutionClass>org.optaplanner.examples.mista2013.domain.Mista2013</solutionClass>
      <planningEntityClass>org.optaplanner.examples.mista2013.domain.Allocation</planningEntityClass>
    
      <scoreDirectorFactory>
        <scoreDefinitionType>BENDABLE</scoreDefinitionType>
        <bendableHardLevelCount>1</bendableHardLevelCount>
        <bendableSoftLevelCount>3</bendableSoftLevelCount>
        <incrementalScoreCalculatorClass>org.optaplanner.examples.mista2013.solver.score.Mista2013IncrementalScoreCalculator</incrementalScoreCalculatorClass>
      </scoreDirectorFactory>
      <termination>
