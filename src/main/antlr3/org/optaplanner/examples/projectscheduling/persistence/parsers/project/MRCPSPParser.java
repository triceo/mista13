...
public class MRCPSPParser extends Parser {
	...
	// $ANTLR start "parse"
	// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:28:1: parse returns [RawProjectData value] : BEGIN_PAUSE sourceInfo PAUSE summary PAUSE projects PAUSE precedence PAUSE requestsAndDurations PAUSE resourceAvailabilities PAUSE ;
	public final RawProjectData parse() throws RecognitionException {
		...
		try {
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:28:38: ( BEGIN_PAUSE sourceInfo PAUSE summary PAUSE projects PAUSE precedence PAUSE requestsAndDurations PAUSE resourceAvailabilities PAUSE )
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:29:3: BEGIN_PAUSE sourceInfo PAUSE summary PAUSE projects PAUSE precedence PAUSE requestsAndDurations PAUSE resourceAvailabilities PAUSE
			{
	...
	// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:38:1: sourceInfo : 'file with basedata' WHITESPACE ':' WHITESPACE STRING NEWLINE 'initial value random generator' ':' WHITESPACE number ;
	public final void sourceInfo() throws RecognitionException {
		try {
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:38:11: ( 'file with basedata' WHITESPACE ':' WHITESPACE STRING NEWLINE 'initial value random generator' ':' WHITESPACE number )
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:39:3: 'file with basedata' WHITESPACE ':' WHITESPACE STRING NEWLINE 'initial value random generator' ':' WHITESPACE number
			{
	...
	public final SituationMetadata summary() throws RecognitionException {
		...
		try {
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:42:42: ( 'projects' WHITESPACE ':' WHITESPACE pn= number NEWLINE 'jobs (incl. supersource/sink )' ':' WHITESPACE jn= number NEWLINE 'horizon' WHITESPACE ':' WHITESPACE hz= number NEWLINE 'RESOURCES' NEWLINE WHITESPACE '- renewable' WHITESPACE ':' WHITESPACE rr= number WHITESPACE 'R' NEWLINE WHITESPACE '- nonrenewable' WHITESPACE ':' WHITESPACE nr= number WHITESPACE 'N' NEWLINE WHITESPACE '- doubly constrained' WHITESPACE ':' WHITESPACE dr= number WHITESPACE 'D' )
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:43:3: 'projects' WHITESPACE ':' WHITESPACE pn= number NEWLINE 'jobs (incl. supersource/sink )' ':' WHITESPACE jn= number NEWLINE 'horizon' WHITESPACE ':' WHITESPACE hz= number NEWLINE 'RESOURCES' NEWLINE WHITESPACE '- renewable' WHITESPACE ':' WHITESPACE rr= number WHITESPACE 'R' NEWLINE WHITESPACE '- nonrenewable' WHITESPACE ':' WHITESPACE nr= number WHITESPACE 'N' NEWLINE WHITESPACE '- doubly constrained' WHITESPACE ':' WHITESPACE dr= number WHITESPACE 'D'
			{
	...
	// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:55:1: projects returns [ProjectMetadata value] : 'PROJECT INFORMATION:' NEWLINE 'pronr. #jobs rel.date duedate tardcost MPM-Time' NEWLINE WHITESPACE nr= number WHITESPACE jb= number WHITESPACE rd= number WHITESPACE dd= number WHITESPACE tc= number WHITESPACE mt= number ;
	public final ProjectMetadata projects() throws RecognitionException {
		...
		try {
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:55:41: ( 'PROJECT INFORMATION:' NEWLINE 'pronr. #jobs rel.date duedate tardcost MPM-Time' NEWLINE WHITESPACE nr= number WHITESPACE jb= number WHITESPACE rd= number WHITESPACE dd= number WHITESPACE tc= number WHITESPACE mt= number )
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:56:3: 'PROJECT INFORMATION:' NEWLINE 'pronr. #jobs rel.date duedate tardcost MPM-Time' NEWLINE WHITESPACE nr= number WHITESPACE jb= number WHITESPACE rd= number WHITESPACE dd= number WHITESPACE tc= number WHITESPACE mt= number
			{
	...
	// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:66:1: precedence returns [List<Precedence> value] : 'PRECEDENCE RELATIONS:' NEWLINE 'jobnr. #modes #successors successors' ( precedenceLine )+ ;
	public final List<Precedence> precedence() throws RecognitionException {
		...
		try {
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:66:44: ( 'PRECEDENCE RELATIONS:' NEWLINE 'jobnr. #modes #successors successors' ( precedenceLine )+ )
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:67:3: 'PRECEDENCE RELATIONS:' NEWLINE 'jobnr. #modes #successors successors' ( precedenceLine )+
			{
			...
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:70:3: ( precedenceLine )+
			int cnt1=0;
			loop1:
			while (true) {
				int alt1=2;
				...
				switch (alt1) {
				case 1 :
					// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:70:4: precedenceLine
					{
	...
	// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:72:1: precedenceLine returns [Precedence value] : NEWLINE WHITESPACE jn= number WHITESPACE md= number WHITESPACE sc= number ( WHITESPACE ss= number )* ( WHITESPACE )* ;
	public final Precedence precedenceLine() throws RecognitionException {
		...
		try {
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:72:42: ( NEWLINE WHITESPACE jn= number WHITESPACE md= number WHITESPACE sc= number ( WHITESPACE ss= number )* ( WHITESPACE )* )
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:73:3: NEWLINE WHITESPACE jn= number WHITESPACE md= number WHITESPACE sc= number ( WHITESPACE ss= number )* ( WHITESPACE )*
			{
			...
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:78:3: ( WHITESPACE ss= number )*
			loop2:
			while (true) {
				int alt2=2;
				...
				switch (alt2) {
				case 1 :
					// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:78:4: WHITESPACE ss= number
					{
			...
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:80:3: ( WHITESPACE )*
			loop3:
			while (true) {
				int alt3=2;
				...
				switch (alt3) {
				case 1 :
					// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:80:4: WHITESPACE
					{
	...
	// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:82:1: requestsAndDurations returns [List<Request> value] : 'REQUESTS/DURATIONS:' NEWLINE 'jobnr. mode duration R 1 R 2 N 1 N 2' NEWLINE ( '-' )+ ( NEWLINE ( WHITESPACE rr= number )+ )+ ;
	public final List<Request> requestsAndDurations() throws RecognitionException {
		...
		try {
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:82:51: ( 'REQUESTS/DURATIONS:' NEWLINE 'jobnr. mode duration R 1 R 2 N 1 N 2' NEWLINE ( '-' )+ ( NEWLINE ( WHITESPACE rr= number )+ )+ )
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:83:3: 'REQUESTS/DURATIONS:' NEWLINE 'jobnr. mode duration R 1 R 2 N 1 N 2' NEWLINE ( '-' )+ ( NEWLINE ( WHITESPACE rr= number )+ )+
			{
			...
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:86:3: ( '-' )+
			int cnt4=0;
			loop4:
			while (true) {
				int alt4=2;
				...
				switch (alt4) {
				case 1 :
					// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:86:4: '-'
					{
			...
			int jobNumber = 1;
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:88:3: ( NEWLINE ( WHITESPACE rr= number )+ )+
			int cnt6=0;
			loop6:
			while (true) {
				int alt6=2;
				...
				switch (alt6) {
				case 1 :
					// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:89:3: NEWLINE ( WHITESPACE rr= number )+
					{
					match(input,NEWLINE,FOLLOW_NEWLINE_in_requestsAndDurations537); 
					 List<Integer> resources = new ArrayList<Integer>(); 
					// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:91:5: ( WHITESPACE rr= number )+
					int cnt5=0;
					loop5:
					while (true) {
						int alt5=2;
						...
						switch (alt5) {
						case 1 :
							// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:91:6: WHITESPACE rr= number
							{
	...
	// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:107:1: resourceAvailabilities returns [List<Integer> value] : 'RESOURCEAVAILABILITIES:' NEWLINE ( . )+ NEWLINE ( WHITESPACE number )+ ;
	public final List<Integer> resourceAvailabilities() throws RecognitionException {
		...
		try {
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:107:53: ( 'RESOURCEAVAILABILITIES:' NEWLINE ( . )+ NEWLINE ( WHITESPACE number )+ )
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:108:3: 'RESOURCEAVAILABILITIES:' NEWLINE ( . )+ NEWLINE ( WHITESPACE number )+
			{
			...
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:110:3: ( . )+
			int cnt7=0;
			loop7:
			while (true) {
				int alt7=2;
			...
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:111:3: ( WHITESPACE number )+
			int cnt8=0;
			loop8:
			while (true) {
				int alt8=2;
				...
				switch (alt8) {
				case 1 :
					// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:111:4: WHITESPACE number
					{
	...
	// $ANTLR start "number"
	// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:113:1: number returns [Integer value] : NUMBER ;
	public final Integer number() throws RecognitionException {
		...
		try {
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:113:31: ( NUMBER )
			// /home/lpetrovi/Workspaces/Stuff/projectscheduling/src/main/antlr3/org/optaplanner/examples/projectscheduling/persistence/parsers/project/MRCPSP.g:113:33: NUMBER
			{
